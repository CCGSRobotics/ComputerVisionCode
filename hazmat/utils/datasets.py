...
class LoadWebcam:  # for inference 
    def __init__(self, img_size=416):
        self.cam = cv2.VideoCapture(0) #raspivid -o - -t 0 -hf -w 800 -h 400 -fps 24 |cvlc --file-caching=500 -vvv stream:///dev/stdin --sout '#standard{access=http,mux=ts,dst=:8160}' :demux=h264
        #self.cam = cv2.VideoCapture('http://192.168.100.72:8080')
        #416
        self.height = img_size
...
class LoadImagesAndLabels(Dataset):  # for training/testing
    def __init__(self, path, img_size=416, augment=False):
        ...
        path = "G:/PyTorch/yolov3/data/coco/example_single_class.txt"
