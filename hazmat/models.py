...
def load_darknet_weights(self, weights, cutoff=-1):
    ...
    #fp = open(weights, 'rb')
    #os.path.join(os.getcwd(),os.path.join("weights",os.path.join("weights","darknet53.conv.74")))
    fp = open(os.path.join(os.getcwd(),os.path.join("weights",os.path.join("weights","darknet53.conv.74"))), "rb")
    #fp = open("D:/PyTorch/yolov3/weights/weights/darknet53.conv.74", "rb")
